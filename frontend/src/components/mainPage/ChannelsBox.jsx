    ...
    <li className="nav-item w-100" key={channel.id}>
      <Dropdown as={ButtonGroup} className="d-flex show dropdown btn-group">
        <button
          ...
          onClick={hundleChannelClick(channel.id)}
        >
        ...
        {channel.removable
          ? <>
            ...
            <Dropdown.Menu>
              <Dropdown.Item href="#/action-1">{t('mainPage.rename')}</Dropdown.Item>
              <Dropdown.Item href="#/action-2">{t('mainPage.remove')}</Dropdown.Item>
            </Dropdown.Menu>
            </>
            : null          
        }
  ...
  return (
    <div className="col-4 col-md-2 border-end px-0 bg-light flex-column  d-flex">
      <div className="d-flex mt-1 justify-content-between mb-2 ps-4 pe-2 p-4">
        ...
        <button type="p-0 text-primary btn btn-group-vertical" onClick={addChannel} className="p-0 text-dark btn btn-group-vertical">
